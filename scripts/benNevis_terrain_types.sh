...
# gdalwarp -r cubic -expand gray -ot Byte -tap -tr 10 10 -s_srs WGS84 -t_srs '+proj=utm +zone=30 +datum=WGS84 +units=m +no_defs' ../data/benNevis_terrain_types.tiff ../data/benNevis_terrain_types_UTM.tiff

rm ../data/benNevis_terrain_types_aligned.tiff
