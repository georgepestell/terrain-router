...
gdal_rasterize -l lines -l multipolygons -burn 1.0 -tr 0.00001 0.00001 -a_nodata 0.0 -te -5.127361122222 56.761527788889 -4.96513889987 56.864861122305 -ot Float32 -of GTiff -co "PROFILE=GeoTIFF" ../data/benNevis_water.xml ../data/benNevis_water.tiff
...
### Project to UTM
# gdalwarp -r cubic -ot Byte -tap -tr 3 3 -s_srs WGS84 -t_srs '+proj=utm +zone=30 +datum=WGS84 +units=m +no_defs' ../data/benNevis_water.tiff ../data/benNevis_water_2.tiff
